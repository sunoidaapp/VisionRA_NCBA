...
public class TabVb extends CommonVb {
	...
	private String subTabRecordIndicatorDesc = "";
	List<SmartSearchVb> smartSearchOpt = null;
	
	public boolean compare(TabVb vObject){
		if(this.tab != vObject.tab ||
				!this.tabDescription.equals(vObject.tabDescription) || this.tabStatus != vObject.tabStatus){
			return false;
		}
		return true;
	}
	...
	public String getSubTabRecordIndicatorDesc() {
		return subTabRecordIndicatorDesc;
	}
	public void setSubTabRecordIndicatorDesc(String subTabRecordIndicatorDesc) {
		this.subTabRecordIndicatorDesc = subTabRecordIndicatorDesc;
	}
}
