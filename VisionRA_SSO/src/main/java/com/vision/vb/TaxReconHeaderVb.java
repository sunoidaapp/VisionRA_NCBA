...
public class TaxReconHeaderVb extends CommonVb {
	...
	private ArrayList<TaxReconHeaderVb> tableNamesList = new ArrayList<>();
	private	List<TaxReconHeaderVb> children = new ArrayList<>();
        private List<TaxReconHeaderVb> selectionCriteriaLst = null;
	private List<TaxReconActivityFilterVb> relationJoinsLst = null;
	List<TaxReconActivityFilterVb> filtersLst = new ArrayList<TaxReconActivityFilterVb>();
	...
	public List<TaxReconHeaderVb> getChildren() {
		return children;
	}

	public void setChildren(List<TaxReconHeaderVb> children) {
	...
	public List<TaxReconHeaderVb> getSelectionCriteriaLst() {
		return selectionCriteriaLst;
	}

	public void setSelectionCriteriaLst(List<TaxReconHeaderVb> selectionCriteriaLst) {
	...
	public ArrayList<TaxReconHeaderVb> getTableNamesList() {
		return tableNamesList;
	}

	public void setTableNamesList(ArrayList<TaxReconHeaderVb> tableNamesList) {
	...
	public List<TaxReconActivityFilterVb> getRelationJoinsLst() {
		return relationJoinsLst;
	}

	public void setRelationJoinsLst(List<TaxReconActivityFilterVb> relationJoinsLst) {
		this.relationJoinsLst = relationJoinsLst;
	}

	public List<TaxReconActivityFilterVb> getFiltersLst() {
		return filtersLst;
	}

	public void setFiltersLst(List<TaxReconActivityFilterVb> filtersLst) {
