...
public class CommonVb implements Serializable{
	...
	public String getCountryLebDesc() {
		return countryLebDesc;
	}

	public void setCountryLebDesc(String countryLebDesc) {
		this.countryLebDesc = countryLebDesc;
	}
