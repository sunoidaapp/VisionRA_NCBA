...
public class ReconActivityFilterVb extends CommonVb {
	...
	List<ReconActivityFilterVb> joinsLst = null;
	...
	public List<ReconActivityFilterVb> getJoinsLst() {
		return joinsLst;
	}

	public void setJoinsLst(List<ReconActivityFilterVb> joinsLst) {
