...
@Component
public class ReconTabRelationDao extends AbstractDao<ReconHeaderVb> {
	...
	protected int doInsertionApprReconTabRelation(ReconActivityFilterVb vObject) {
		String query = " INSERT INTO RA_RECON_TAB_RELATIONS (RULE_ID_AT,RULE_ID,FROM_TABLE_ID,TO_TABLE_ID,JOIN_TYPE_NT,JOIN_TYPE         "
	...
	protected int doInsertionPendReconTabRelation(ReconActivityFilterVb vObject) {
		String query = " INSERT INTO RA_RECON_TAB_RELATIONS_PEND (RULE_ID_AT,RULE_ID,FROM_TABLE_ID,TO_TABLE_ID,JOIN_TYPE_NT,JOIN_TYPE         "
				+ " ,JOIN_STRING_1,JOIN_STRING_2,JOIN_STRING_3,JOIN_STRING_4,JOIN_STRING_5,FILTER_CONDITION_1,FILTER_CONDITION_2    "
				+ " ,FILTER_CONDITION_3,FILTER_CONDITION_4,FILTER_CONDITION_5,STATUS_NT,STATUS,RECORD_INDICATOR_NT,RECORD_INDICATOR "
				+ " ,MAKER,VERIFIER,INTERNAL_STATUS,DATE_LAST_MODIFIED,DATE_CREATION)                                               "
				+ "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "
	...
	protected int doInsertionReconTabRelationHis(ReconActivityFilterVb vObject) {
	...
	protected int doInsertionPendReconTabRelationDc(ReconActivityFilterVb vObject) {
		String query = " INSERT INTO RA_RECON_TAB_RELATIONS_PEND(RULE_ID_AT,RULE_ID,TABLE_ID,TABLE_NAME,ALIAS_NAME,STATUS_NT,STATUS,          "
	...
	protected int deleteApprReconTabRelation(ReconHeaderVb vObject) {
		String query = "DELETE FROM RA_RECON_TAB_RELATIONS  WHERE RULE_ID = ?";

		Object[] args = { vObject.getRuleId() };
		return getJdbcTemplate().update(query, args);
	}

	protected int deletePendReconTabRelation(ReconHeaderVb vObject) {
		String query = "DELETE FROM RA_RECON_TAB_RELATIONS_PEND  WHERE RULE_ID = ?";

		Object[] args = { vObject.getRuleId() };
		return getJdbcTemplate().update(query, args);
	}

	public List<ReconActivityFilterVb> getQueryReconTabRelation(ReconHeaderVb dObj, int intStatus,Boolean checkFlag) {
		...
		strQueryAppr = new String("  SELECT TAPPR.RULE_ID_AT,            " + "         TAPPR.RULE_ID,               "
				...
				+ "         TAPPR.DATE_CREATION          "
				+ "    FROM RA_RECON_TAB_RELATIONS TAPPR,NUM_SUB_TAB T2, NUM_SUB_TAB T3  "
		...
		strQueryPend = new String("  SELECT TPEND.RULE_ID_AT,            " + "         TPEND.RULE_ID,               "
				...
				+ "         TPEND.DATE_CREATION          "
				+ "    FROM RA_RECON_TAB_RELATIONS_PEND TPEND,NUM_SUB_TAB T2, NUM_SUB_TAB T3  "
	...
	public List<ReconActivityFilterVb> getQueryReconTabRelationRuleid(ReconHeaderVb dObj, int intStatus) {
		List<ReconActivityFilterVb> collTemp = null;
		setServiceDefaults();
		String strQueryAppr = null;
		String strQueryPend = null;
	...
	protected RowMapper getReconTabRelationMapper() {
		RowMapper mapper = new RowMapper() {
			...
			public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
				ReconActivityFilterVb reconTabRelationVb = new ReconActivityFilterVb();
	...
	public List getLhsAndRhsTableId(String ruleId,int status) {
		try {
			...
			if(status == Constants.STATUS_ZERO)
				...
				tableName = "RA_Recon_Act_Filter_PEND";
